  ...
  83                     ; 26 }
  86  0015 81            	ret
 112                     ; 28 _Bool time_synchronization_10ms(void)
 112                     ; 29 {
 113                     	switch	.text
 114  0016               _time_synchronization_10ms:
 118                     ; 30 	if (is_ready == TRUE)
 120                     	btst	L11_is_ready
 121  001b 2407          	jruge	L55
 122                     ; 32 		is_ready = FALSE;
 ...
 134  0024 4f            	clr	a
 137  0025 81            	ret
 161                     ; 39 uint8_t get_random_byte(void)
 161                     ; 40 {
 162                     	switch	.text
